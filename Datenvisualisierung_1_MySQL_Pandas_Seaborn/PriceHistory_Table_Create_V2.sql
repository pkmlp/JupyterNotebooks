...
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -5 MONTH), 1, "Product A", 500, 400, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -7 MONTH), 1, "Product A", 600, 500, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -8 MONTH), 1, "Product A", 500, 600, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -9 MONTH), 1, "Product A", 400, 500, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -10 MONTH), 1, "Product A", 500, 400, CURRENT_USER, "Update");
...
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -5 MONTH), 1, "Product C", 80, 70, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -9 MONTH), 1, "Product C", 90, 80, CURRENT_USER, "Update");
INSERT INTO PriceHistory VALUES (0, DATE_SUB(NOW(), INTERVAL -11 MONTH), 1, "Product C", 80, 90, CURRENT_USER, "Update");
